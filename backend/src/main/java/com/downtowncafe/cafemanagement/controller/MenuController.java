...
public class MenuController {
        ...
        private void initializeMenu() {
                ...
                menuItems.put("Cold Beverages", new CopyOnWriteArrayList<>(List.of(
                                ...
                                new MenuItemDTO("fb1", "Healthy Mix", "Avocado, Basil, Ginger, Mint, Lemon Juice",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb2", "Detox Mix", "Basil, Cucumber, lemon Juice, Ginger",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb3", "Magic Mango", "Mango, Banana, Lemon, Coconut Milk, Mint",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb4", "Healthy Mix", "Avocado, Basil, Ginger, Mint, Lemon Juice",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb5", "Orange Kicker", "Orange Juice, Carrot, Fresh Ginger",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb6", "Mint Hint", "Mint, Green Apple, lemon Juice",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb7", "Red Notice", "Beetroot, Watermelon", new BigDecimal("25"),
                                                "Fresh Blends"),
                                new MenuItemDTO("fb8", "Watermelon Rose", "Watermelon, Rose Syrup",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("fb9", "Ultimate Green", "Mint, Lemon Juice, Sugar Syrup",
                                                new BigDecimal("25"), "Fresh Blends"),
                                new MenuItemDTO("mok1", "Mojito", "Classic, Passion Fruit, Peach, Strawberry",
                                                new BigDecimal("25"), "Mocktails"),
                                new MenuItemDTO("mok2", "Sunrise", "Orange Juice, Grenadine Syrup, sprite",
                                                new BigDecimal("25"), "Mocktails"),
                                new MenuItemDTO("mok3", "Strawberry Fresco", "Strawberry Puree, Sprite",
                                                new BigDecimal("25"), "Mocktails"),
                                new MenuItemDTO("mok4", "Ibrik Mule", "Strawberry, Ginger Ale, Rosemary, Ginger Juice",
                                                new BigDecimal("25"), "Mocktails"),
                                new MenuItemDTO("mok5", "Blue Lagoon", "Lemon Juice, Sprite, Blue Coracco",
                                                new BigDecimal("25"), "Mocktails"),
                                new MenuItemDTO("mok6", "Rose", "Grape Fruit, Rose Syrup, Soda water",
                                                new BigDecimal("25"), "Mocktails"),
                                new MenuItemDTO("mok7", "Colada", "Pineapple, Coconut Syrup, Whipping Cream",
                                                new BigDecimal("25"), "Mocktails"),
                ...
                menuItems.put("Breakfasts", new CopyOnWriteArrayList<>(List.of(
                                new MenuItemDTO("bf1", "Three Eggs Selection",
                                                "Scrambled, fried, boiled, shakshuka, sunny side up, omelette or poached",
                                                new BigDecimal("35"), "Breakfast"),
                                new MenuItemDTO("bf2", "Hummus with olive oil",
                                                "Served with arabic bread, cucumber, tomato and pickles",
                                                new BigDecimal("30"), "Breakfast"),
                                new MenuItemDTO("bf3", "Labneh with olive oil",
                                                "Served with arabic bread, cucumber, tomato and pickles",
                                                new BigDecimal("30"), "Breakfast"),
                                new MenuItemDTO("bf4", "Grilled halloumi cheese",
                                                "Served with arabic bread, cucumber, tomato and pickles",
                                                new BigDecimal("35"), "Breakfast"),
                                new MenuItemDTO("bf5", "Pan cake or french toast",
                                                "Served with honey or syrup and whipped cream", new BigDecimal("35"),
                                                "Breakfast"),
                                new MenuItemDTO("bf6", "Cereals", "Served with honey and milk", new BigDecimal("25"),
                                                "Breakfast"),
                                new MenuItemDTO("bf7", "Pastry Basket",
                                                "Croissants, muffins and danish pastries with jam and butter",
                                                new BigDecimal("45"), "Breakfast"),
                                new MenuItemDTO("bf8", "Continental breakfast",
                                                "Your choice of freshly squeezed seasonal, fruit juices, morning bakeries, freshly sliced fruits,fruit yogurt, toast bread with jam and butter, cereal brewed coffee, Tea or hot chocolate",
                                                new BigDecimal("60"), "Breakfast"),
                                new MenuItemDTO("bf9", "English breakfast",
                                                "Your choice of freshly squeezed seasonal fruit juices, morning bakeries, freshly sliced fruits cereal, toast bread with jam and butter two free range eggs served with (hash brown potato, grilled tomato, sausages, baked beans) brewed coffee, Tea or hot chocolate",
                                                new BigDecimal("80"), "Breakfast"),
                                new MenuItemDTO("bf10", "Arabic breakfast",
                                                "Your choice of freshly squeezed seasonal fruit juices, freshly sliced fruits marinated black and green olives, cheese, labneh foul mudammas cooked with garlic tomato & olive oil «shakshuka» egg with tomato, onion & parsley brewed coffee, Tea or hot chocolat",
                                                new BigDecimal("70"), "Breakfast"))));
                // Starters & Salads
                menuItems.put("Starters & Salads", new CopyOnWriteArrayList<>(List.of(
                                ...
                                new MenuItemDTO("ap2", "Vegetable spring rolls", "", new BigDecimal("40"),
                                                "Appetizers"),
                                ...
                                new MenuItemDTO("sl1", "Smoked salmon Nicoise salad",
                                                "Potato, green beans, anchovy, tomato, onion, black olive and accompanied with smoked salmon served with frensh dressing",
                                                new BigDecimal("55"), "Salads"),
                                new MenuItemDTO("sl2", "Caesar salad",
                                                "Crisp Romanian lettuce with zest Caesar dressing topped with shaved parmesan cheese, garlic croutons choise of grilled chicken, grilled shrimps or smoked salmon",
                                                new BigDecimal("45"), "Salads"),
                                new MenuItemDTO("sl3", "Greek salad",
                                                ...
                                                new BigDecimal("45"), "Salads"),
                                new MenuItemDTO("sl4", "Green salad",
                                                "Assorted Green garden lettuice, cucumber, green pepper, asparagus, served with French dressing",
                                                new BigDecimal("35"), "Salads"),
                                new MenuItemDTO("sl5", "Rocca salad",
                                                "Fresh Rocca lettuice with onion, sumac, cherry tomato and lemon dressing",
                                                new BigDecimal("35"), "Salads"),
                                new MenuItemDTO("sl6", "Smoked salmon platter",
                                                "Thin slice of smoked salmon served with garden lettuice capers sliced onion brown toast bread and lemon wedges",
                                                new BigDecimal("65"), "Salads"),
                                new MenuItemDTO("sl7", "Arabic cold mezzah",
                                                "Hummus, mutabbal, vine leaves, tabouleh and fattouch served with arabic bread",
                                                new BigDecimal("40"), "Salads"),
                                new MenuItemDTO("sl8", "Grilled pineapple avocado salad",
                ...
                menuItems.put("Main Courses & Sandwiches", new CopyOnWriteArrayList<>(List.of(
                                ...
                                new MenuItemDTO("mn4", "Grilled salmon",
                                                ...
                                                new BigDecimal("80"), "Main Courses"),
                                new MenuItemDTO("mn5", "Grilled Hammour",
                                                "Marinated grilled hammour served with grilled vegetables and french fries accompanied with lemon butter sauce",
                                                new BigDecimal("70"), "Main Courses"),
                                new MenuItemDTO("mn6", "Curry",
                                                "The famous indian spicy food with your choice of chicken or lamb served with white rice or paratha and green salad",
                                                new BigDecimal("50"), "Main Courses"),
                                new MenuItemDTO("mn7", "Biryani",
                                                "Traditional indian food with your choice of chicken, lamb or vegetables with papadum and raita",
                                                new BigDecimal("45"), "Main Courses"),
                                new MenuItemDTO("mn8", "Nasi Goreng",
                                                "Traditional indonesian vegetables fried rice with your choice chicken or beef topped with fried egg, chicken sautee and peanut sauce",
                                                new BigDecimal("55"), "Main Courses"),
                                new MenuItemDTO("sw1", "Club sandwich",
                                                ...
                                                new BigDecimal("45"), "Sandwiches"),
                                new MenuItemDTO("sw2", "Chicken burger",
                                                "200gm ground chicken breast accompanied with fried egg, slice cheddar cheese, tomato, lettuce and mayonnaise",
                                                new BigDecimal("40"), "Sandwiches"),
                                new MenuItemDTO("sw3", "Beef burger",
                                                "200gm ground beef accompanied with fried egg, slice cheddar cheese, tomato, lettuce and mayonnaise",
                                                new BigDecimal("50"), "Sandwiches"),
                                new MenuItemDTO("sw4", "Downtown sandwich",
                                                "Slice of roast beef served in focaccia bread, Dijjon mustard, grilled onion, tomato and lettuce",
                                                new BigDecimal("45"), "Sandwiches"),
                                new MenuItemDTO("sw5", "Steak sandwich",
                                                "Grilled strip steak on crisp french baguette accompanied with cheese, tomato, mayonnaise and crispy lettuce",
                                                new BigDecimal("55"), "Sandwiches"),
                                new MenuItemDTO("sw6", "Warm Chicken sandwich",
                                                "Griiled chicken breast, tomato, lettuce, mayonnaise on french baguette",
                                                new BigDecimal("45"), "Sandwiches"),
                                new MenuItemDTO("sw7", "Vegetable and cheese sandwich",
                                                "Marinated grilled vegetable in herbs served in baguette accompanied with grilled cheese, mayonnaise, lettuce and tomato",
                                                new BigDecimal("35"), "Sandwiches"),
                                new MenuItemDTO("sw8", "Grilled halloumi sandwich",
                                                "Grilled halloumi sandwich served in arabic bread and oregano accompanied with tomato and cucumber",
                                                new BigDecimal("35"), "Sandwiches"),
                                new MenuItemDTO("sw8", "Chicken fajita",
                ...
                menuItems.put("Italian", new CopyOnWriteArrayList<>(List.of(
                                ...
                                new MenuItemDTO("pz1", "Margherita", "Mozzarella cheese, Oregano, Basil, Tomato sauce",
                                                new BigDecimal("45"), "Pizza"),
                                new MenuItemDTO("pz2", "Vegetable pizza",
                                                "Champignon, Capsicum (green, red and yellow), black olives, onion, Mozzarella cheese,Oregano, Tomato sauce",
                                                new BigDecimal("40"), "Pizza"),
                                ...
                                new MenuItemDTO("pz4", "Frutti Di Mare",
                                                ...
                                                new BigDecimal("45"), "Pizza"),
                                new MenuItemDTO("pz5", "Hawaian",
                                                "Marinated Chicken, pineapple, Mozzarella cheese, Oregano, Tomato sauce",
                                                new BigDecimal("45"), "Pizza"))));
                // Desserts & Bakery
